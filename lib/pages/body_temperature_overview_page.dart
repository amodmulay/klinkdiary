...
final List<BodyTemperatureRecord> bodyTemperatureHistory = [
  BodyTemperatureRecord(dateTime: DateTime(2022, 2, day++, 8, 0, 1 + random.nextInt(58)), bodyTemperature: 35.0 + random.nextDouble() * 7.0),
  BodyTemperatureRecord(dateTime: DateTime(2022, 2, day++, 8, 0, 1 + random.nextInt(58)), bodyTemperature: 35.0 + random.nextDouble() * 7.0),
  BodyTemperatureRecord(dateTime: DateTime(2022, 2, day++, 8, 0, 1 + random.nextInt(58)), bodyTemperature: 35.0 + random.nextDouble() * 7.0),
  BodyTemperatureRecord(dateTime: DateTime(2022, 2, day++, 8, 0, 1 + random.nextInt(58)), bodyTemperature: 35.0 + random.nextDouble() * 7.0),
  BodyTemperatureRecord(dateTime: DateTime(2022, 2, day++, 8, 0, 1 + random.nextInt(58)), bodyTemperature: 35.0 + random.nextDouble() * 7.0),
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[_bodyTemperatureDetailsButton],
              ),
            ),
          ),
        ));
